...
export function LoginForm() {
  ...
  return (
    ...
    >
      ...
      <Divider plain style={{ fontSize: 13, color: '#8c8c8c' }}>O continúa con</Divider>
      ...
      <div style={{ textAlign: 'center' }}>
        <Typography.Text type="secondary">¿Aún no tienes cuenta? </Typography.Text>
        <Link 
          href="/register" 
          style={{ color: '#207781', fontWeight: 600 }}
        >
          Regístrate gratis
        </Link>
      </div>
